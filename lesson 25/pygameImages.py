...
backImage=p.transform.scale(p.image.load(r"/Users/mahin/Python codingal/lesson 25/backgroundpyhton.png").convert(),(500,500))
penguinImage=p.transform.scale(p.image.load(r"/Users/mahin/Python codingal/lesson 25/penguinpython.png").convert_alpha(),(500,500))
